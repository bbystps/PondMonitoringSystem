    ...
    $.ajax({
      ...
      success: function(response) {
        if (response.status === 'success') {
          ...
          // ✅ Re-enable Start Feeder button here
          let btnFeeder = document.getElementById("btn_feeder");
          btnFeeder.disabled = false;
          btnFeeder.innerText = "Start Feeder";
          changeButtonColor("btn_feeder", "#10b981"); // green
          changeStatusColor("feeder_status", "#282828"); // default idle

          // ✅ Also reset feeder icon to green
          document.getElementById("feeder_icon").style.background = "green";
