  ...
  function updateChart() {
    ...
    fetch(url)
      ...
      .then(data => {
        ...
        dateAxis.renderer.labels.template.fill = am4core.color("#4f4f4f");
        ...
        valueAxis.renderer.labels.template.fill = am4core.color("#4f4f4f");
        ...
        var createSeries = function(field, name) {
          ...
          bullet.circle.fill = am4core.color("#4f4f4f");
        ...
        lineChart.legend.labels.template.fill = am4core.color("#4f4f4f");
